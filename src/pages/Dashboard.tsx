...
import { TrendingUp, TrendingDown, Minus, Leaf, Factory, Target, Award, Bell, CheckCircle, AlertTriangle, Info, X } from "lucide-react";
...
const Dashboard = () => {
  ...
  const handleExportPDF = async () => {
    ...
    doc.text("CoalMineNetZero", pageWidth - 60, 80, { align: "right" });
    ...
    doc.setTextColor(120, 120, 120);
    doc.text(
      "Report generated by CoalMineNetZero Dashboard | Confidential",
      pageWidth / 2,
      pageHeight - 30,
      { align: "center" }
    );
