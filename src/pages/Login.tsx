...
import { Loader2, Leaf, Sun, Wind } from "lucide-react";
              ...
              <div className="mt-6 p-4 eco-gradient border border-green-200 rounded-lg animate-fade-in">
                ...
                <div className="text-sm text-green-700 space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs">operator@coalmine.gov.in</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="font-medium">Regulator:</span>
                    <span className="text-xs">regulator@cpcb.gov.in</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="font-medium">Admin:</span>
                    <span className="text-xs">admin@coalmine.gov.in</span>
                  </div>
